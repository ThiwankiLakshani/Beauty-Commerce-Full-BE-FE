...
class RegisterForm extends StatefulWidget {
  ...
  /// Called when register succeeds. Receives `{access_token, refresh_token, user}`.
  ...
  /// Show logo + title/description above fields.
  final bool showHeader;

  /// Show "Already have an account?" footer.
          ...
          children: [
            if (widget.showHeader) ...[
              Center(
                child: Column(
                  children: [
                    // Same logo/header style as Login
                    Image.asset(
            ...
            // Confirm password (use base field to avoid ctor mismatch)
            AppTextField(
